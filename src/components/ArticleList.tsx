      ...
      <article className="shadow my-4 flex flex-col">
        ...
        <div className="bg-white flex flex-col justify-start p-6">
          ...
          <Link href="#" className="text-slate-900 pb-6">
            ...
            nihil nam similique rerum quibusdam perferendis sapiente voluptas
            est consequatur temporibus distinctio rem blanditiis odit dolores
            molestiae! Quam non a accusamus!
          </Link>
